...
{
    public:
        typedef earray<ExptT> expression_type;
    ...
    public:
        ...
        //! copy constructor
        earray(const expression_type &a):_expression(a._expression) {}

        earray(const ExpT &e):_expression(e) {}
        ...
        //! get element value
        value_type operator[](size_t index) const { return _expression[index]; }
};
