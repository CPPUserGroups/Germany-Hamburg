...
//! 
//! This version of the subtraction operator is used for situations where the LHS
...
//! \brief subtraction operator
//! 
//! Overload of the subtraction operator where the LHS of the - operation is an 
...
//! \brief subtraction operator
//! 
//! Overload of the subtraction operator where the LHS of the - operation is 
