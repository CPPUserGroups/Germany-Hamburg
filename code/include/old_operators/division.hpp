...
//! 
//! This version of the division operator is used for situations where the LHS
...
//! \brief division operator
//! 
//! Overload of the division operator where the LHS of the / operation is an 
...
//! \brief division operator
//! 
//! Overload of the division operator where the LHS of the / operation is 
